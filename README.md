...
<h3 align="center">A Python developer and a passionate learner from Paraguay.</h3>

**<h2 align="left"> About me:</h2>**
- My interestes are focused on developing market solutions from **data and machine learning applications**. 
- I am always improving my skills about **Python** libraries, **Linux**,**MySQL** and currently learning about **AWS**, **Docker** and **Flask**.
